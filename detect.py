...
def detect(text, save_img=False):
    ...
    source = "http://192.168.249.233:81/stream"
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                sound = pygame.mixer.Sound(
                    r"C:\Users\HP\PycharmProjects\ObjectDetection\yolov7-main\valorant-match-found-sound.mp3")
...
if __name__ == '__main__':
    ...
    with sr.Microphone() as source:
        ...
        print("Input from the user: "+text)
    
    pygame.init()
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str,
                        default='yolov7.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='http://192.168.249.233/stream',
